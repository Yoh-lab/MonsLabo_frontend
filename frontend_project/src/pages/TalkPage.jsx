...
const TalkPage = () => {
  ...
  const [_logOutput, setLogOutput] = useState(
    location.state?._logOutput || null
  );
  const [num_response, setNumResponse] = useState(
    location.state?.num_response || null
  );
  ...
  return (
    <div className="flash_back">
      ...
      <div
        ...
        style={{
          backgroundImage: `url(${talk_img})`,
          backgroundSize: "cover",
          backgroundPosition: "center",
        }}
      >
        <div className="back_sheet z-10 relative"></div>
        <div className="flex flex-col justify-center items-center z-20 absolute top-50% left-50%">
          <div className="border-2 bg-white flex justify-center items-center">
            {image_url ? (
              <img src={image_url} className="max-h-72" alt="Image" />
            ) : (
              <div className="text-center">
                <img src="none.png" className="max-h-72" />
                <p>No Image</p>
              </div>
            )}
          </div>
          ...
          <div className="relative w-3/5">
            ...
            <h2>
              <form
                className="my-4 flex items-center justify-center pt-2"
                onSubmit={
                  isLoading == false
                    ? num_response < 5
